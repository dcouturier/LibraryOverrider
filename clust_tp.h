...
#if !(_CLUST_TP_H) || defined(TRACEPOINT_HEADER_MULTI_READ)
#define _CLUST_TP_H
...
TRACEPOINT_EVENT(
	...
	TP_FIELDS(
		...
		ctf_integer(void (CL_CALLBACK * pfn_notify )(const char *, const void *, size_t, void *), pfn_notify_field, pfn_notify)
...
TRACEPOINT_EVENT(
	...
	TP_ARGS(
		cl_mem, memobj,
		void (CL_CALLBACK * pfn_notify )( cl_mem , void* ), pfn_notify,
		void *, user_data
	),
	TP_FIELDS(
		ctf_integer(cl_mem, memobj_field, memobj)
		ctf_integer(void (CL_CALLBACK * pfn_notify )( cl_mem , void* ), pfn_notify_field, pfn_notify)
...
TRACEPOINT_EVENT(
	...
	TP_ARGS(
		...
		const cl_device_id *, device_list,
		const char *, options,
		void (CL_CALLBACK * pfn_notify )(cl_program , void * ), pfn_notify,
		void *, user_data
	),
	TP_FIELDS(
		ctf_integer(cl_program, program_field, program)
		...
		ctf_integer(void (CL_CALLBACK * pfn_notify )(cl_program , void * ), pfn_notify_field, pfn_notify)
		ctf_integer(void *, user_data_field, user_data)
	)
)
TRACEPOINT_EVENT(
...
TRACEPOINT_EVENT(
	...
	TP_ARGS(
		...
		void (CL_CALLBACK * pfn_notify )(cl_event, cl_int, void *), pfn_notify,
		void *, user_data
	),
	TP_FIELDS(
		ctf_integer(cl_event, event_field, event)
		ctf_integer(cl_int, command_exec_callback_type_field, command_exec_callback_type)
		ctf_integer(void (CL_CALLBACK * pfn_notify )(cl_event, cl_int, void *), pfn_notify_field, pfn_notify)
		ctf_integer(void *, user_data_field, user_data)
	)
)
TRACEPOINT_EVENT(
